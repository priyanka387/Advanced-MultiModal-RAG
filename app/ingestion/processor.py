...
def save_processed_locally(data, source_type, filename):
    """
    Save parsed/chunked data as JSON.
...
def process_file(file_path: str, filename: str, source_type: str):
    ...
    try:
        ...
        # ----------------------------------------------------
        print("STEP 5 : Saving processed JSON")
        ...
        # ----------------------------------------------------
        print("STEP 7 : Creating Qdrant points")
        ...
        # ----------------------------------------------------
        print("STEP 8 : Uploading to Qdrant")
